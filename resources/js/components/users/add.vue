            ...
            <section slot="body">
                ...
                >
                    ...
                    <button
                        ...
                        type="submit"
                        v-bind:class="{
                            'btn bg-purple btn flat': !this.form.id,
                        ...
                        axios
                            ...
                            .then(response => {
                                ...
                                Swal.fire({
                                    position: "center",
                                    icon: "success",
                                    title: `El usuario ${this.form.name} Ha sido modificado`,
                        ...
                        axios
                            ...
                            .then(response => {
                                Swal.fire({
                                    position: "center",
                                    icon: "success",
                                    title: `El usuario ${this.form.name} Ha sido registrado`,
                                    showConfirmButton: false,
                                    timer: 1500
                                });
                                $("#model").modal("hide");
